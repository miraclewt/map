...
%   allows the geographic cell extents to be set precisely. The geographic
%   limits will be adjusted slightly, if necessary, to ensure an integer
%   number of cells in each dimenstion.
%
