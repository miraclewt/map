...
%
%   R = MAPREFCELLS(xWorldLimits,yWorldLimits,rasterSize) constructs a
%   referencing object for a raster of cells spanning the specified limits
%   in planar coordinates, with the numbers of rows and columns specified
%   by rasterSize.
%
%   R = MAPREFCELLS(xWorldLimits,yWorldLimits,cellExtentInWorldX,cellExtentInWorldY)
%   allows the cell extents to be set precisely. The limits of the raster
%   will be adjusted slightly, if necessary, to ensure an integer number of
%   cells in each dimenstion.
%
%   R = MAPREFCELLS(xWorldLimits,yWorldLimits,___,Name,Value) allows the
